...
//      }
//       const normaltext = convertHTML(data?.notes);
//       const char = 490;
...
//     return (
//         <Card className="NoteCard rounded-4 p-3 shadow-sm border-0 mb-" style={{ backgroundColor: '#F4FAB3' || '#fafaf8ff' }}>
...
const NoteCard = ({data, addFavoriteOnClick,notesEditOnClick, notesDeleteOnClick,onShowMore,noteFavoriteIcon}) => {
    ...
    return (
        <Card className="NoteCard rounded-4 p-3 shadow-sm border-0 col" style={{ backgroundColor: '#F4FAB3' || '#fafaf8ff', minHeight:"37vh"}} >
