  ...
  const jsxJson = {
    create_test: [
        ...
        change: (selected) =>
          dispatch(
            selected_students_in_schedule({
              type_of_questions: Array.isArray(selected)
                ? selected[0]?.value
                : selected?.value,
            })
          ),
      ...
      // },
      {
        ...
        options: (() => {
          ...
          if (selected.includes("all")) {
            ...
            return [
              { label: "All", value: "all" },
              ...(Array.isArray(
                teachersState?.studentsPerformance?.assignedTest
                  ?.jsonStudentsData
              )
                ? teachersState?.studentsPerformance?.assignedTest?.jsonStudentsData.map(
                    (student) => ({
        ...
        Err: commonState?.app_data?.validated
          ? commonState?.app_data?.validationMessage?.students
          : null,
      },
      {
        name: "Date",
    ...
    editStudent: [
      ...
      },
      {
        ...
        value: teachersState?.teacher_PostStudents?.data?.data?.last_name || "",
        change: (e) => {
          if (/^[A-Za-z]*$/.test(e.target.value)) {
      ...
      },
      {
        ...
        value:
          teachersState?.teacher_PostStudents?.data?.data?.student_email || "",
        change: (e) =>
        ...
        disabled: true,
        Err: commonState?.app_data?.validated
          ? commonState?.app_data?.validationMessage?.student_email
          : null,
      },
      {
        ...
        change: (e) => {
          ...
          if (/^[A-Z0-9]*$/.test(value)) {
            dispatch(updatePostStudentData({ student_reg_no: value }));
          }
        },
        divClassName: "col-12 mb-4",
        className: "modal-inputs",
        isMandatory: true,
        Err: commonState?.app_data?.validated
          ? commonState?.app_data?.validationMessage?.student_reg_no
          : null,
      },
    ],
    createStudent: [
      {
        ...
        disabled:
          ...
          teachersState?.teacher_CreateStudents?.data?.student_file?.length > 0
            ...
            : false,
        Err: commonState?.app_data?.validated
          ? commonState?.app_data?.validationMessage?.name
          : null,
      },
      {
        name: "Enter a Contact Number",
      ...
      },
      {
        ...
        disabled:
          ...
          teachersState?.teacher_CreateStudents?.data?.student_file?.length > 0
            ...
            : false,
        Err: commonState?.app_data?.validated
          ? commonState?.app_data?.validationMessage?.register_no
          : null,
      },
      {
    ...
    student_performance_modal: [
      {
        title: "Name",
        divClassName:
          "col-3 border-end border-start text-center p-3 text-primary-emphasis",
      },
      {
        title: "Overall",
    ...
    settings_details: [
      {
        ...
        type: teachersState?.settings_password?.show_old_password ? "text" : "password" ,
        title: " ",
        category: "input",
        ...
        eyeFunction: () =>
          dispatch(
              update_settings_eye({
                  show_old_password: !teachersState?.settings_password?.show_old_password,
              })
          ),
      ...
      {
        name: "New Password",
        type: teachersState?.settings_password?.show_new_password ? "text" : "password" ,
        title: " ",
        category: "input",
        placeholder: "Current Password",
        ...
        eyeFunction: () =>
          dispatch(
              update_settings_eye({
                show_new_password: !teachersState?.settings_password?.show_new_password,
              })
          ),
      ...
      },
      {
        ...
        type: teachersState?.settings_password?.show_confirm_password ? "text" : "password" ,
        title: " ",
        category: "input",
        ...
        eyeFunction: () =>
          dispatch(
              update_settings_eye({
                show_confirm_password: !teachersState?.settings_password?.show_confirm_password,
              })
          ),
    ...
    teachers_profile: [
      {
        ...
        divClassName: "mb-3",
        isMandatory: false,
        Err: teachersState?.errors?.first_name || null,
      },
      {
        name: "Last Name",
        type: "text",
        ...
        divClassName: "mb-3",
        isMandatory: false,
        Err: teachersState?.errors?.last_name || null,
      },
      {
        name: "Email",
        type: "text",
      ...
      },
      {
        ...
        divClassName: "mb-3",
        isMandatory: false,
        Err: teachersState?.errors?.phone_number || null,
      },
      {
        name: "Address",
        title: " ",
