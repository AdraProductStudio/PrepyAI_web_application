...
import { updateSettingsInputs } from "../Slices/StudentSlice";
import { handleChangePassword } from "../Actions/StudentAction";
...
const StudentSettings = () => {
  ...
  const settingInputs = studentState?.settingsInputs
            ...
            <form className="row">
              ...
              <div className="d-flex justify-content-center py-md-2">
                <ButtonComponent
                  ...
                  buttonName={studentState?.loading['change_password'] ? <>Saving... <SpinnerComponent/></> : 'Save'}
                  clickFunction={()=> dispatch(handleChangePassword(settingInputs))}
                />
              </div>
            </form>
          </section>
