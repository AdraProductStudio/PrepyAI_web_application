                    ...
                    <Card.Body className="d-flex justify-content-center align-items-center" style={{ height: "700px" }}>
                        <Col xs={8} className="h-100">
                            <div className="w-100 h-100 d-flex flex-column  justify-content-center align-items-center">
                                <h4 className='mb-0 text-center'>PrepyAI is here to help you get ready for your exams or learn things faster by testing your knowledge.</h4>
                                <div className='col-10 mt-4'>
                                    <p className='mb-2'>1. You can generate questions either from the entire textbook or by choosing specific chapters or topics. To do this, click on the book title, chapter, or topic you're interested in from the sidebar to generate questions.</p>
                                    <p className='mb-2'>2. You'll get 20 questions about the topic you choose. After answering them, you'll get a summary of your results.</p>
                                    <p className='mb-2'>3. You can also redo tests you've done before.</p>
                                    <p className='mb-2'>4. If you didn't upload a book with bookmarks, the questions will be random from the entire content</p>
                                    <p className='mt-4 mb-0'>We hope AnatomyAI makes studying for exams easier and boosts your confidence in your learning journey!</p>
                                </div>
